module Scene3d exposing
    ...
    , Entity
    , point, lineSegment, triangle, facet, quad, block, sphere, bumpySphere, cylinder, cone
    , triangleWithShadow, facetWithShadow, quadWithShadow, blockWithShadow, sphereWithShadow, bumpySphereWithShadow, cylinderWithShadow, coneWithShadow
    , mesh, meshWithShadow
    , group, nothing
...
@docs point, lineSegment, triangle, facet, quad, block, sphere, bumpySphere, cylinder, cone
...
@docs triangleWithShadow, facetWithShadow, quadWithShadow, blockWithShadow, sphereWithShadow, bumpySphereWithShadow, cylinderWithShadow, coneWithShadow
...
sphere givenMaterial givenSphere =
    bumpySphere (Material.textured givenMaterial) givenSphere
...
sphereWithShadow givenMaterial givenSphere =
    bumpySphereWithShadow (Material.textured givenMaterial) givenSphere


{-| Like `sphere`, but can accept a normal-mapped material.
-}
bumpySphere : Material.Bumpy coordinates -> Sphere3d Meters coordinates -> Entity coordinates
bumpySphere givenMaterial givenSphere =
    Entity.sphere True False givenMaterial givenSphere


{-| Like `sphereWithShadow`, but can accept a normal-mapped material.
-}
bumpySphereWithShadow : Material.Bumpy coordinates -> Sphere3d Meters coordinates -> Entity coordinates
bumpySphereWithShadow givenMaterial givenSphere =
